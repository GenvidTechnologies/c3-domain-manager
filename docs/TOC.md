...
- `decisions/0026-fs-watch-platform-confound-and-upstream-routing.md` — close ADR 0025's node-version/platform confound, widen the `txId` double-bump to both watch paths, and route the fix to mcp-utils rather than patching locally (issue #68)
